...
export const ApiCreateProject = (bodyType: Type<any>) => {
  return applyDecorators(
    ApiOperation({
      summary: '프로젝트 생성',
      description:
        '새로운 프로젝트를 생성합니다. 생성한 사용자가 프로젝트 소유자가 됩니다.',
    }),
...
export const ApiGetProjects = () => {
  return applyDecorators(
    ApiOperation({
      summary: '프로젝트 목록 조회',
      description:
        '사용자가 참여 중인 프로젝트 목록을 조회합니다. 페이지네이션과 검색을 지원합니다.',
    }),
    ApiQuery({
      name: 'page',
...
export const ApiGetProject = () => {
  return applyDecorators(
    ApiOperation({
      summary: '프로젝트 상세 조회',
      description:
        '특정 프로젝트의 상세 정보를 조회합니다. 프로젝트 멤버만 접근 가능합니다.',
    }),
    ApiParam({
      name: 'id',
...
export const ApiUpdateProject = (bodyType: Type<any>) => {
  return applyDecorators(
    ApiOperation({
      summary: '프로젝트 정보 수정',
      description:
        '프로젝트 정보를 수정합니다. 프로젝트 소유자 또는 관리자만 수정 가능합니다.',
    }),
    ApiParam({
      name: 'id',
      description: '프로젝트 고유 식별자',
...
export const ApiDeleteProject = () => {
  return applyDecorators(
    ApiOperation({
      summary: '프로젝트 삭제',
      description:
        '프로젝트를 삭제합니다. 프로젝트 소유자만 삭제 가능하며, 관련된 모든 데이터가 함께 삭제됩니다.',
    }),
    ApiParam({
      name: 'id',
      description: '프로젝트 고유 식별자',
