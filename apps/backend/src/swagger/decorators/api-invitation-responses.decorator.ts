...
export const ApiCreateInvitation = (bodyType: Type<any>) => {
  return applyDecorators(
    ApiOperation({
      summary: '프로젝트 초대 생성',
      description:
        '새로운 프로젝트 초대를 생성합니다. 이메일 또는 사용자 ID로 초대할 수 있습니다.',
    }),
    ...
    ApiBadRequestResponse({
      description:
        '잘못된 요청 데이터 (이메일/사용자ID 누락, 유효성 검사 실패)',
...
export const ApiGetInvitation = () => {
  return applyDecorators(
    ApiOperation({
      summary: '초대 정보 조회',
      description:
        '토큰으로 초대 정보를 조회합니다. 초대 수락/거절 전에 초대 내용을 확인할 때 사용합니다.',
    }),
    ApiParam({
      name: 'token',
      description: '초대 토큰',
...
export const ApiGetReceivedInvitations = () => {
  return applyDecorators(
    ApiOperation({
      summary: '받은 초대 목록 조회',
      description:
        '사용자가 받은 초대 목록을 조회합니다. 상태별 필터링이 가능합니다.',
    }),
    ApiQuery({
      name: 'status',
...
export const ApiGetProjectInvitations = () => {
  return applyDecorators(
    ApiOperation({
      ...
      description:
        '특정 프로젝트의 모든 초대 목록을 조회합니다. 프로젝트 소유자 또는 관리자만 접근 가능합니다.',
    }),
    ApiParam({
      name: 'projectId',
      description: '프로젝트 ID',
...
export const ApiDeleteInvitation = () => {
  return applyDecorators(
    ApiOperation({
      summary: '초대 삭제',
      description:
        '초대를 삭제합니다. 초대를 보낸 사용자만 삭제할 수 있습니다.',
    }),
    ApiParam({
      name: 'id',
      description: '초대 ID',
