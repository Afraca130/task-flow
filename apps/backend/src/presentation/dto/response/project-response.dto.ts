...
import { ProjectPriority as DomainProjectPriority, Project, ProjectStatus } from '../../../domain/entities/project.entity';
...
export class ProjectResponseDto {
    ...
    static fromDomain(project: Project): ProjectResponseDto {
        return new ProjectResponseDto({
            ...
            priority: this.mapDomainPriorityToDto(project.priority),
    ...
    private static mapDomainPriorityToDto(priority: DomainProjectPriority): ProjectPriority {
        switch (priority) {
            case DomainProjectPriority.LOW:
                return ProjectPriority.LOW;
            case DomainProjectPriority.MEDIUM:
                return ProjectPriority.MEDIUM;
            case DomainProjectPriority.HIGH:
                return ProjectPriority.HIGH;
            case DomainProjectPriority.URGENT:
