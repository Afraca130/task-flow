...
import { ArrowLeft, Bell, CheckCheck, Clock, Search, Settings } from 'lucide-react';
                    ...
                    <div className='flex-1 min-w-0'>
                      <div className='flex items-start justify-between gap-4'>
                        ...
                        <div className='flex flex-col items-end gap-2'>
                          <span
                            className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${priorityBadge.color}`}
                          >
