...
```css
--color-primary: #0052cc --color-background-neutral: #fafbfc --color-background-card: #ffffff
  --color-text-primary: #172b4d --color-border: #dfe1e6;
```

### 간격 시스템 (8px Grid)

```css
--space-100: 8px --space-200: 16px --space-300: 24px --space-400: 32px;
```
